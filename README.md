...
<h2 id="how-it-works">Как работает скрипт?</h2>
...
<h2 id="media-support">Какие медиафайлы может пересылать бот?</h2>
...
<h2 id="contribution">Содействие</h2>
