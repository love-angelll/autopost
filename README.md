...
## Содержание RU
1. [Вступление](#[RU]-Бот-для-автоматической-публикации-сообщений-из-Telegram-в-ВКонтакте)
2. [Зачем нужен?](##Зачем-нужен-этот-проект-?)
3. [Как работает ?](##Как-работает-скрипт-?)
4. [Структура проекта](##Структура-проекта)
5. [Какие медиафайлы может пересылать ?](##Какие-медиафайлы-может-пересылать-бот-?)
6. [Пример использования](##Пример-использования)
7. [Установка и запуск проекта](##Установка-и-запуск-проекта)
8. [Подробности реализации](##Подробности-реализации)
9. [Особенности](##Особенности)
10. [Содействие](##Содействие)
