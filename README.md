...
<h2 id="зачем-нужен">Зачем нужен этот проект ?</h2>
...
<h2 id="как-работает-скрипт">Как работает скрипт ?</h2>
...
<h2 id="какие-медиафайлы-может-пересылать-бот">Какие медиафайлы может пересылать бот</h2>
...
<h2 id="установка-и-запуск-проекта">Установка и запуск проекта</h2>
...
<h2 id="подробности-реализации">Подробности реализации</h2>
...
<h2 id="содействие">Содействие</h2>
